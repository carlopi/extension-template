...
#### Main build
# For regular CLI build, we link the quark extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/quark/quark.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/quark/quark.duckdb_extension'
